...
async function main() {
  ...
  const tripData = [
    ...
    {
      title: "Summer Tokyo Exploration",
      description: "Mid-August exploration in Tokyo",
    ...
    {
      title: "NYC Summer Getaway",
      description: "Late summer weekend in New York City",
      startDate: new Date("2026-08-15"),
      endDate: new Date("2026-08-18"),
      status: "PLANNED",
      budget: 160000,
      currency: "INR",
      destName: "New York City",
    },
    {
      title: "July-August Bali Crossing",
      description: "Boundary trip starting in late July and ending in early August",
    ...
    {
      title: "August-September Paris Transition",
      description: "Boundary trip starting in late August and ending in early September",
